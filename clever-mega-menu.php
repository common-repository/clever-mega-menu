...
final class Clever_Mega_Menu
{
    ...
    function _register_assets()
    {
        ...
        wp_register_style('clever-nav-menu', $assets_uri.'backend/css/clever-nav-menu.min.css', array(), self::VERSION);
        wp_register_style('clever-menu-item', $assets_uri . 'backend/css/clever-menu-item.min.css', array('wp-color-picker'), self::VERSION);
        wp_register_style('clever-menu-theme', $assets_uri.'backend/css/clever-menu-theme.min.css', array('wp-color-picker'), self::VERSION);
        wp_register_style('clever-mega-menu-admin', $assets_uri.'backend/css/clever-mega-menu-admin.min.css', array('dashicons', 'wp-color-picker'), self::VERSION);
        wp_register_style('clever-mega-menu-theme-default', $this->settings['baseuri'] . 'assets/frontend/css/clever-mega-menu-theme-default-461836.min.css', array('dashicons'), self::VERSION);

        // Register scripts.
        wp_register_script('wp-color-picker-alpha', $assets_uri . 'backend/js/wp-color-picker-alpha.min.js', array('wp-color-picker'), '1.2.2', true);
        ...
        wp_register_script('clever-mega-menu-admin', $assets_uri . 'backend/js/clever-mega-menu-admin.min.js', array('wp-color-picker-alpha'), self::VERSION, true );
